...
class CLI < Thor
  ...
  # option :image, default: 'https://www.googleapis.com/compute/beta/projects/isucon5-qualify/global/images/isucon5-qualify-base'
  # option :image, default: 'isucon5-qualify-base'
